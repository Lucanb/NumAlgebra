...
% Observatie: foloseste pivotare (partial) pentru robustete numerica.
    ...
    A12p = P1 * A12; %permuta liniile intai

    U12 = SolveLower_(L11, A12p, true); %U12 din L11*U12 = A12p

    L21 = SolveRightUpper_(U11, A21); %L21 din L21*U11 = A21  (rezolvare din dreapta)

    S = A22 - L21 * U12; %Complement Schur

    [L22, U22, P2] = LUBlocuriRecursivPivot(S); %Factorizez S cu pivotare: P2*S = L22*U22

    L21p = P2 * L21; %Pivotarea P2 afecteaza blocurile de jos: trebuie permutat L21

    P = blkdiag(P1, P2);%Dupa recursie fac matricea de permutare P = diag(P1, P2) * [I 0; 0 I] aplicata pe A
